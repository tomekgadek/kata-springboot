...
Najważniejsze komponenty to m.in.:
- **Eureka** – odkrywanie usług (Service Discovery).
- **Spring Cloud Config** – centralne zarządzanie konfiguracją.
- **Spring Cloud Gateway** – brama API (routing, filtrowanie żądań).
- **OpenFeign** – deklaratywny klient HTTP do komunikacji między serwisami.
