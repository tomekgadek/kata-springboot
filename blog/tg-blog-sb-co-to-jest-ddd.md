...
DDD można podzielić na dwa obszary:
- **Strategiczne DDD** – skupione na podziale systemu na konteksty (Bounded Context) i relacje między nimi.
- **Taktyczne DDD** – skupione na implementacji modelu w kodzie.
...
- **Encje (Entities)** – posiadają tożsamość i mogą się zmieniać w czasie.
- **Obiekty wartości (Value Objects)** – są niemutowalne i nie mają tożsamości.
- **Agregaty (Aggregates)** – grupują obiekty i wyznaczają granicę spójności danych.
