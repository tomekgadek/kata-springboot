...
Każdy mikroserwis: – Jest odpowiedzialny za jedną, konkretną funkcjonalność biznesową (np. zarządzanie użytkownikami, płatności, wysyłka e-maili). – Może być rozwijany w innym języku programowania i korzystać z innej technologii bazy danych. – Jest wdrażany, aktualizowany i skalowany całkowicie niezależnie od pozostałych usług.
